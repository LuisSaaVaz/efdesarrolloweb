...
<body>
    <table border="1">
        ...
        <?php
            ...
            // SQL para consultar
            $sql = "SELECT * FROM clientes  WHERE id = (SELECT MAX(id) FROM clientes)";
            $sql = "SELECT * FROM clientes  WHERE id = (SELECT MIN(id) FROM clientes)";
    ...
    <br>
    <a href='./6.html'><button>Volver</button></a>
</body>
</html>